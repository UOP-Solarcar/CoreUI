// Based on https://github.com/microcharts-dotnet/Microcharts/blob/main/Sources/Microcharts.Forms/ChartView.cs  Copyright (c) Aloïs DENIEL. Licensed under the MIT License.
using Microcharts;
using SkiaSharp;
